...
admin = User(name=u'darek', email=u'darek@mail.com', password=u'password', major=u'administrator',
             headline=u"Nazywam się Darek", about_me=u"Jestem ownerem tej biblioteki.")
user1 = User(name=u'Janusz', email=u'james@mail.com', password=u'123456', major='Informatyka', headline=u"Zwykły user",
             about_me=u"User numer 1.")
user2 = User(name=u'test', email=u'test@mail.com', password=u'1234', major='Fizyka', headline=u"Zwykły user",
             about_me=u"User numer 2.")
user3 = User(name=u'test2', email=u'test2@mail.com', password=u'12345', major='Fizyka', headline=u"Zwykły user",
             about_me=u"User numer 3.")
user4 = User(name=u'test3', email=u'test3@mail.com', password=u'123456', major='Matematyka', headline=u"Zwykły user",
             about_me=u"User numer 4.")


book1 = Book(title=u"Sezon Burz", origin_title=u"Opowiadania o wiedźminie", subtitle=u"Cykl wiedźmiński", author=u"Andrzej Sapkowski", isbn='9782811212995',
             translator=u"Jan Kowalski", publisher=u"Mewa", numbers=u"500",
             image='C:\\Users\\Dariusz Marczewski\\PycharmProjects\\Biblioteka_Mikroserwisy\\app\\static\\img\\sezon_burz.jpg',
             summary=u"""
...
""")
book2 = Book(title=u"Krew elfów", origin_title=u"Opowiadania o wiedźminie", subtitle=u"Saga o wiedźminie", author=u"Andrzej Sapkowski", isbn='9788025905340',
             translator=u"Jan Kowalski", publisher=u"Mewa", numbers=u"500",
             image='C:\\Users\\Dariusz Marczewski\\PycharmProjects\\Biblioteka_Mikroserwisy\\app\\static\\img\\krew_elfow.jpg',
             summary=u"""
...
""")
book3 = Book(title=u"Czas pogardy", origin_title=u"Opowiadania o wiedźminie", subtitle=u"Saga o wiedźminie", author=u"Andrzej Sapkowski", isbn='9788498890532',
             translator=u"Jan Kowalski", publisher=u"Mewa", numbers=u"500",
             image='C:\\Users\\Dariusz Marczewski\\PycharmProjects\\Biblioteka_Mikroserwisy\\app\\static\\img\\czas_pogardy.jpg',
             summary=u"""
...
""")
book4 = Book(title=u"Chrzest ognia", origin_title=u"Opowiadania o wiedźminie", subtitle=u"Saga o wiedźminie", author=u"Andrzej Sapkowski", isbn='9783423407090',
             translator=u"Jan Kowalski", publisher=u"Mewa", numbers=u"500",
             image='C:\\Users\\Dariusz Marczewski\\PycharmProjects\\Biblioteka_Mikroserwisy\\app\\static\\img\\chrzest_ognia.jpg',
             summary=u"""
...
""")
book5 = Book(title=u"Wieża Jaskółki", origin_title=u"Opowiadania o wiedźminie", subtitle=u"Saga o wiedźminie", author=u"Andrzej Sapkowski", isbn='9783423247863',
             translator=u"Jan Kowalski", publisher=u"Mewa", numbers=u"500",
             image='C:\\Users\\Dariusz Marczewski\\PycharmProjects\\Biblioteka_Mikroserwisy\\app\\static\\img\\wieza_jaskolki.jpg',
             summary=u"""
...
""")
book6 = Book(title=u"Pani Jeziora", origin_title=u"Opowiadania o wiedźminie", subtitle=u"Saga o wiedźminie", author=u"Andrzej Sapkowski", isbn='9781473211605',
             translator=u"Jan Kowalski", publisher=u"Mewa", numbers=u"500",
             image='C:\\Users\\Dariusz Marczewski\\PycharmProjects\\Biblioteka_Mikroserwisy\\app\\static\\img\\pani_jeziora.jpg',
             summary=u"""
